...
public class ItemGroupMapper {
    ...
    public int merge(ItemGroup i) {
        SqlBuilder param = SqlBuilder.build().append("REPLACE INTO item_group (`group`, code, name, market, type)")
    ...
    public List<ItemGroup> list(String group, String keyWord) {
        SqlBuilder param = SqlBuilder.build().append("select `group`,code, name, market, type from item_group");
