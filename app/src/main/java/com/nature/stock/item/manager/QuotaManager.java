...
import com.nature.stock.common.enums.DefaultQuota;
import com.nature.stock.common.enums.QuotaField;
...
import com.nature.stock.item.http.QuotaHttp;
import com.nature.stock.item.mapper.QuotaMapper;
    ...
    private List<Item> items() {
        ...
        for (String code : codes) {
            for (String fc : fcs) {
                ...
                item.setCode(code);
                item.setType(fc);
                item.setName(DefaultQuota.getName(code) + "-" + QuotaField.codeToName(fc));
                items.add(item);
            }
        }
        return items;
