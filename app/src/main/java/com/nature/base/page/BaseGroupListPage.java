...
import com.nature.stock.page.ItemGroupPage;
...
public abstract class BaseGroupListPage extends ListPage<Group> {
    ...
    protected List<Group> listData() {
        List<Group> list = this.manager().list();
    ...
    private void doAdd() {
        this.doEdit((c) -> this.manager().findByCode(c) != null);
    }
    ...
    protected abstract BaseGroupManager manager();
